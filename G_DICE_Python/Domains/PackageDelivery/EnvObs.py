...
from ...Domains.Base import EnvObs
...
class PackageDeliveryEnvObs(EnvObs):
    ...
    def getXeIndex(self, callerAgentIndex, callerAgentPackageDelta, currentTMAIndex, isOutputOn=False):
        ...
        if isOutputOn:
            print('Agent ', callerAgentIndex, ' called getXeIdx (TMA = ', currentTMAIndex, ', package delta = ',
                  callerAgentPackageDelta, '), xe = ', xe, ', psi = ', self.psi, ', delta = ', self.delta, ', phi = ',
                  self.phi)
